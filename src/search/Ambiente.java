...
public class Ambiente extends Environment {
	...
	public Perception getPercept() {
		...
		if(this.getEstadoAmbiente().getZombies().containsKey(this.getEstadoAmbiente().getPosicionPlanta())) {
			...
			Integer energiaZombie= this.getEstadoAmbiente().getZombies().get(this.getEstadoAmbiente().getPosicionPlanta()).getEnergia();
			Integer energiaPlanta= this.getEstadoAmbiente().getEnergiaPlanta();
		    
			//le resttamos energia
	...
	private void vistaAbajo(PlantaPerception p) {
		...
		Integer yAux = y;
		//El metodo basicamente recorre en una direccion hasta encontrarse con un zombie,limite o girasol
		while (!visto) {
